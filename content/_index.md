...
window.animHandle = 0
function animate() {
  document.querySelector("#inputA").style.color = randomColor()
  document.querySelector("#inputB").style.color = randomColor()
  document.querySelector("#outputS").style.color = randomColor()
  document.querySelector("#outputC").style.color = randomColor()
