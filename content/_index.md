...
function animate() {
  ...
  window.animHandle = setTimeout(animate, 60 / 145 * 1000)
}
...
window.onload = () => {
  ...
  document.body.style.backgroundImage = "url(https://cdn.star.nesdis.noaa.gov/GOES16/ABI/CONUS/GEOCOLOR/20241670211_GOES16-ABI-CONUS-GEOCOLOR-2500x1500.jpg)"
